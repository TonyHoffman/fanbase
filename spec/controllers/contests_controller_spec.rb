...
describe ContestsController do
  ...
  before(:each)do
      # @sport = Factory(:sport)
      # @team = Factory(:team)
      # teamAttr = [:city => "a", :season => "a"]
      # @team = @sport.teams.build(teamAttr)
      # @team = @sport.teams.create(teamAttr)
      
      # @contest = @team.contests.build(:contest)
  ...
  #       post :create, {:contest => {}}, valid_session
  #       assigns(:contest).should be_a_new(Contest)
  #     end
  # 
  ...
  #       put :update, {:id => contest.to_param, :contest => {'these' => 'params'}}, valid_session
  #     end
  # 
  #     it "assigns the requested contest as @contest" do
  #       contest = Contest.create! valid_attributes
  ...
  #       # Trigger the behavior that occurs when invalid params are submitted
  #       Contest.any_instance.stub(:save).and_return(false)
  #       put :update, {:id => contest.to_param, :contest => {}}, valid_session
  #       assigns(:contest).should eq(contest)
  #     end
  # 
